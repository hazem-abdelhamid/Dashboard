...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[38px] w-full max-w-[9.62rem] items-center justify-between whitespace-nowrap bg-[#F9FBFF] rounded-[10px] px-3 py-2 text-sm text-[#7E7E7E] ring-offset-white placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-zinc-800 dark:ring-offset-zinc-950 dark:placeholder:text-zinc-400 dark:focus:ring-zinc-300",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-[1.1rem] w-[1.1rem] opacity-50 text-[black]" />
